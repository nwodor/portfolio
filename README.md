...
**Customer Experience Coworker Level 3 — IKEA, Edmonton AB** *(Jul 2025 – Present)*
Excellent customer service, accurate inventory tracking through IKEA's internal software, efficient issue resolution, stock integrity.

**Carts Coworker — IKEA, Edmonton AB** *(Oct 2024 – Jul 2025)*
Coordinated with warehouse and pickup teams, monitored loading-zone operations, reported equipment issues to management.

**Software Engineering Intern — Lendsqr, Lagos NG** *(Oct 2022 – Nov 2023)*
Designed, developed, and tested fintech software. Wrote clean, maintainable code. Used SQL to query databases. Maintained data integrity and confidentiality across customer-facing systems.
